    ...
    <div className="min-h-screen pb-32 overflow-hidden">
      ...
      <section className="relative pt-48 pb-32 px-6 min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10 w-full">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative z-10 rounded-[2.5rem] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(0,240,255,0.2)] aspect-[4/5] max-w-md mx-auto group">
              <img 
                src="/owner.jpeg" 
                alt="Creator Profile" 
              ...
              <div className="absolute top-6 right-6 flex flex-col gap-2">
                <div className="px-3 py-1 bg-dark/80 backdrop-blur-md rounded border border-white/10 text-[9px] font-black text-white uppercase tracking-widest">
                  Status: Online
                </div>
                <div className="px-3 py-1 bg-dark/80 backdrop-blur-md rounded border border-white/10 text-[9px] font-black text-accent-blue uppercase tracking-widest">
                  Level 01 Creator
                </div>
              </div>
            </div>
            ...
            {/* Floating Ornaments */}
            <div className="absolute -top-10 -right-10 w-32 h-32 bg-accent-purple/20 rounded-full blur-3xl animate-pulse" />
            <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-accent-blue/20 rounded-full blur-3xl animate-pulse delay-700" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-24">
            <h2 className="text-accent-purple font-black text-xs uppercase tracking-[0.3em] mb-4">The Challenge</h2>
            <h3 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase mb-8">Why This Exists</h3>
            <p className="text-gray-500 text-lg max-w-2xl mx-auto italic">Engineering doesn't have to be a nightmare of 2-hour lectures and cryptic textbooks.</p>
          </motion.div>
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-transparent via-white/[0.01] to-transparent">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
           <motion.div {...fadeInUp}>
              <h2 className="text-accent-blue font-black text-xs uppercase tracking-[0.3em] mb-4">The Solution</h2>
              <h3 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase mb-10">Neural Learning Speed</h3>
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeInUp} className="text-center mb-24">
            <h3 className="text-4xl font-black italic tracking-tighter uppercase mb-4">The Mission Flow</h3>
            <p className="text-gray-500 text-sm font-black uppercase tracking-[0.2em]">Simple steps to mastery</p>
          </motion.div>
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <GlassCard className="p-12 md:p-20 border-accent-purple/20 bg-dark/40 relative overflow-hidden text-center">
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-accent-purple/10 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2" />
            
            <motion.div {...fadeInUp}>
              <div className="w-32 h-32 rounded-full border-4 border-accent-purple p-1 mx-auto mb-10 overflow-hidden">
              ...
              <h2 className="text-accent-purple font-black text-xs uppercase tracking-[0.3em] mb-4">Origin Story</h2>
              <h3 className="text-4xl md:text-5xl font-black italic tracking-tighter uppercase mb-8">Built by a Student, for Students</h3>
              <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto font-light mb-12 italic">
      ...
      <section className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
            <motion.div {...fadeInUp}>
              <h2 className="text-3xl md:text-5xl font-black italic tracking-tighter uppercase mb-8">The Bigger Vision</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <GlassCard className="p-16 border-accent-blue/40 bg-gradient-to-br from-accent-blue/10 via-transparent to-accent-purple/10 animate-pulse-border relative overflow-hidden">
            <motion.div {...fadeInUp} className="relative z-10">
              <h2 className="text-4xl md:text-6xl font-black italic tracking-tighter uppercase mb-8">Start Learning Smarter Today</h2>
              <p className="text-gray-400 text-lg mb-12 max-w-xl mx-auto italic font-light">
                Why learn in hours when you can master in minutes? Join the repository and deploy your knowledge.
              </p>
              <div className="flex flex-wrap justify-center gap-6">
                <Link to="/" className="px-12 py-5 bg-white text-dark rounded-2xl font-black text-xl hover:scale-105 active:scale-95 transition-all shadow-[0_20px_40px_rgba(255,255,255,0.1)]">
                  Explore Now
                </Link>
                <Link to="/notes" className="px-12 py-5 border border-white/20 glass-card rounded-2xl font-black text-xl text-white hover:bg-white/5 transition-all">
                  View Notes
                </Link>
              </div>
            </motion.div>
...
function ProblemCard({ icon, title, desc }) {
  return (
    <motion.div 
      whileHover={{ y: -10 }}
      className="p-10 glass-card border-white/5 bg-white/[0.01] hover:bg-white/[0.03] transition-all h-full"
    >
      ...
      <h4 className="text-xl font-black italic uppercase tracking-tighter mb-4">{title}</h4>
...
function ValueCard({ title, desc }) {
  return (
    <motion.div 
      ...
      className="p-8 glass-card border-white/5 bg-white/[0.01] text-center group cursor-default"
    >
      <div className="text-xs font-black uppercase tracking-[0.2em] text-accent-purple mb-2 group-hover:text-accent-blue transition-colors">{title}</div>
      <div className="text-[10px] text-gray-600 font-black uppercase tracking-widest">{desc}</div>
    </motion.div>
  );
}
